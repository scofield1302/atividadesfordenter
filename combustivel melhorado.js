...
function verifyInputsContainer() {
    ...
    if (inputs_validos === qtd_inputs && qtd_inputs > 0) {
        ...
        document.getElementById("distance").innerText = resultado.distancia_Percorrida_km.toFixed(2);
        document.getElementById("car_consumption").innerText = resultado.consumo_Medio_gasolina.toFixed(2);
        document.getElementById("needed_comsumption_1").innerText = resultado.consumo_Necessario_Litros.toFixed(2);
        document.getElementById("needed_comsumption_2").innerText = (resultado.consumo_Necessario_Litros * 2).toFixed(2);
        document.getElementById("total_cost").innerText = ((resultado.consumo_Necessario_Litros * 2) * cheaper_value).toFixed(2);
        document.getElementById("cheaper_station").innerText = cheaper_station;
    } else {
